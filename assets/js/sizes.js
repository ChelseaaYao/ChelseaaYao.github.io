...
// 数据格式：{ long:[长袖], "slim-t":[修身短袖], "oversize-t":[宽松短袖], pants:[长裤], shorts:[短裤], skirts:[半身裙], dresses:[连衣裙] }
//   条目：{ img:"closet/ 下文件名(可选)", brand, item, size,
//          各围度 cm（可只记部分）, n:"备注(可选)" }
//   long/slim-t/oversize-t 围度：bust 胸围 / shoulder 肩宽 / length 衣长(后中) / sleeve 袖长 / hem 下摆围 / cuff 袖口
...
(function(){
  ...
  function render(sz, ms){
    ...
    [["long", "🧥&ensp;Long Sleeve"], ["slim-t", "👕&ensp;Slim T"], ["oversize-t", "🎽&ensp;Oversize T"],
